...
def generate_launch_description():
    node = launch_ros.actions.LifecycleNode(
        package='fmi_robot_simulator',
        executable='fmi_robot_simulator_node',
        name='fmi_robot_simulator_node',
        namespace='',
        parameters=[os.path.join(
            ament_index_python.packages.get_package_share_directory('fmi_robot_simulator'),
            'config',
            'fmi_robot_kinematic_simulator_params.yaml'
        )],
        output='screen')
